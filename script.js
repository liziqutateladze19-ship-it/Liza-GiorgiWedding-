...
const CONFIG = {
  ...
  rsvpEndpoint: "https://script.google.com/macros/s/AKfycbyy6MynDmIRvtRkUMIfGDbG3Z9IbgkhMBYHAWo4yqiM8SOsyNcFZLN5qXaOkjVK49JRYA/exec"
};
...
function resolveSmartAsset(img) {
  ...
  const tryNext = () => {
    ...
    probe.src = `${candidate}?asset-v=12`;
  };
